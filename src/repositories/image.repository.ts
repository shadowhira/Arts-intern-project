...
> {
  ...
  constructor(
    ...
    @repository.getter('AlbumRepository')
    protected albumRepositoryGetter: Getter<AlbumRepository>,
    ...
    this.album = this.createBelongsToAccessorFor(
      'album',
      albumRepositoryGetter,
    );
